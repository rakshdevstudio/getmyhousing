...
import com.getmyhousing.common.service.LoggingService;
...
public class LoggingAspect {
	...
	@Pointcut("execution (* com.getmyhousing.rental.controller.UserController.*(..))")
	...
	@AfterReturning(value = "execution (* com.getmyhousing.rental.controller.UserController.*(..))", returning = "result")
	...
	@AfterThrowing(value = "execution (* com.getmyhousing.rental.controller.UserController.*(..))", throwing = "e")
