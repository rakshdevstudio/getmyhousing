...
public class AssociateLeadHistoryDTO {
	...
	public String toString() {
		return "AssociateLeadHistoryDTO [id=" + id + ", associateLeadId=" + associateLeadId + ", assignedTo="
				+ assignedTo + ", assignedBy=" + assignedBy + ", assignedDate=" + assignedDate + ", callDate="
				+ callDate + ", callBy=" + callBy + ", callResponse=" + callResponse + ", callNotes=" + callNotes
				+ ", statusChangeFrom=" + statusChangeFrom + ", statusChangeTo=" + statusChangeTo + ", followupDate="
				+ followupDate + ", status=" + status + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy
				+ ", createdDate=" + createdDate + ", updatedDate=" + updatedDate + ", createdByName=" + createdByName
				+ ", assignToName=" + assignToName + ", assignedByName=" + assignedByName + ", remarks=" + remarks
				+ "]";
	}
